...
//函数内部参数和外部参数的简写
func divisionOperation2(dividend dividend: Double, divisor: Double) -> Double {
    return dividend / divisor
}
let div2 = divisionOperation2(dividend: 3.6, divisor: 1.2)
print(div2)
//不能使用#了，直接在第一个参数那里使用 外部+内部 参数定义, 在第二个参数及其以后的参数使用一个定义就可以了
func divisionOperation3(sum1 sum1: Double, sum2: Double, sum3: Double) -> Double {
...
func joinString(s1: String, toString: String, joinString: String = "?") -> String {
